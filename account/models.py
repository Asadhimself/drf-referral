...
class AccountManager(BaseUserManager):
    ...
    def _create_user(
        self, phone_number, username=None, password=None, email=None, **extra_fields
    ):
    ...
    def create_user(
        ...
        return self._create_user(
            phone_number, username, password, email, **extra_fields
        )

    def create_superuser(
        self, phone_number, password, username=None, email=None, **extra_fields
    ):
...
class Account(AbstractUser):
    ...
    invite = models.ForeignKey(
        "InviteKey", on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    def clean(self):
        ...
        if self.invite == self.user_invite:
            raise ValidationError({"invite": "You can't enter your invite code."})
